...
function [Network2,  Best_Cost] = Train_GBO(nP,MaxIt,Network,Xtr,Ytr)
%% Initialization
...
lb = -1*ones(1,TotalNum);
ub = +1*ones(1,TotalNum);
...
for i=1:nP
    Cost(i) = feval(CostFuncName,X(i,:),Xtr,Ytr,Network);      % Calculate the Value of Objective Function
end
...
for it=1:MaxIt
    ...
    for i=1:nP                
        ...
        Xnew_Cost = feval(CostFuncName,Xnew,Xtr,Ytr,Network);
...
Network2 = ConsNet_Fcn(Network,Best_X);
end
